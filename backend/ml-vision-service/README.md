...
- **Python 3.11+** on your PATH (`python --version`). On Windows, install from [python.org](https://www.python.org/downloads/) and tick **“Add python.exe to PATH”** (or use the **py** launcher if the installer added it).
...
4. Optional: run `.\setup-windows.ps1` from this folder (creates `.venv` and installs dependencies).
