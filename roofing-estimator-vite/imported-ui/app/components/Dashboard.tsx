...
import { Ruler, FileText, FileSignature, TrendingUp } from 'lucide-react';
            ...
            {recentMeasurements.length > 0 ? (
              <div className="space-y-3">
                {recentMeasurements.map((measurement) => (
                  ...
                  >
                    <div>
                      <p className="text-sm text-gray-900">{measurement.projectName}</p>
                      <p className="text-xs text-gray-500">
                        {measurement.adjustedArea.toFixed(0)} sq ft • {measurement.roofType}
                      </p>
                    </div>
                    <span className="text-xs text-gray-400">{measurement.date}</span>
                  </div>
                ))}
              </div>
            ) : (
