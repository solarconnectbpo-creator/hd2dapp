...
import { a as Ma } from "./chunk-X2JEUMCS.js";
import { a as Ub, b as Pa, c as Fa } from "./chunk-AJGKN5FZ.js";
import { a as Ea } from "./chunk-BPTWZPZ6.js";
import { a as ra } from "./chunk-GVYQ2MV7.js";
import { a as rb } from "./chunk-CAEAJPBH.js";
import { a as Ha } from "./chunk-HJG35BQ3.js";
import { a as ib, b as gb } from "./chunk-5U3HZZCI.js";
import { b as db, c as wa } from "./chunk-WQ5ZC6ME.js";
import {
  a as Ka,
  b as $b,
  d as hb,
  ...
  i as Ta,
  j as xa,
} from "./chunk-V6RJRUKY.js";
import { b as P } from "./chunk-R6PWD5CA.js";
import { a as tb } from "./chunk-BDF6MEVU.js";
import { a as za } from "./chunk-OEIACSKL.js";
import { a as V, b as K, c as Aa, d as nb } from "./chunk-F2ZMVLJV.js";
import { a as u, b as ya, c as fb } from "./chunk-VGILZD7B.js";
import { a as $ } from "./chunk-RXYBLNW3.js";
import { a as Ia, b as J } from "./chunk-TXOEXY5C.js";
import { d as Qb, e as Q } from "./chunk-VIMSDF2W.js";
var De = (function () {
  var c =
  ...
  var e,
    g = WebAssembly.instantiate(s(c), {}).then(function (k) {
      ((e = k.instance),
  ...
  function s(k) {
    for (var j = new Uint8Array(k.length), d = 0; d < k.length; ++d) {
      var n = k.charCodeAt(d);
      j[d] = n > 96 ? n - 97 : n > 64 ? n - 39 : n + 4;
    }
    for (var t = 0, d = 0; d < k.length; ++d)
      j[t++] = j[d] < 60 ? o[j[d]] : (j[d] - 60) * 64 + j[++d];
    return j.buffer.slice(0, t);
  }
  function b(k) {
  ...
  function p(k, j, d, n) {
    var t = e.exports.sbrk,
      ...
      i = r(j);
    (f.set(i, a), n && n(a, a, j.length, d));
    var l = k(h, a, j.length, d);
    f = new Uint8Array(e.exports.memory.buffer);
    var m = new Uint32Array(d);
    (new Uint8Array(m.buffer).set(f.subarray(h, h + d * 4)),
      i.set(f.subarray(a, a + j.length * 4)),
      t(a - t(0)));
    for (var w = 0; w < j.length; ++w) j[w] = m[j[w]];
    return [m, l];
  }
  function E(k, j, d, n) {
    var t = e.exports.sbrk,
  ...
  function F(k, j, d, n, t, a, h) {
    var f = e.exports.sbrk,
      i = f(j),
      l = f(n * t),
      m = new Uint8Array(e.exports.memory.buffer);
    m.set(r(d), l);
    var w = k(i, j, l, n, t, a, h),
      x = new Uint8Array(w);
    return (x.set(m.subarray(i, i + w)), f(i - f(0)), x);
  }
  function y(k) {
    for (var j = 0, d = 0; d < k.length; ++d) {
      var n = k[d];
      j = j < n ? n : j;
    }
    return j;
  ...
  function O(k, j, d, n, t, a, h) {
    var f = e.exports.sbrk,
      i = f(d * n),
      l = f(d * a),
      m = new Uint8Array(e.exports.memory.buffer);
    (m.set(r(j), l), k(i, d, n, t, l, h));
    var w = new Uint8Array(d * n);
    return (w.set(m.subarray(i, i + d * n)), f(i - f(0)), w);
  }
  return {
    ready: g,
    supported: !0,
    reorderMesh: function (k, j, d) {
      var n = j
        ? d
          ? e.exports.meshopt_optimizeVertexCacheStrip
          : e.exports.meshopt_optimizeVertexCache
        : void 0;
      return p(e.exports.meshopt_optimizeVertexFetchRemap, k, y(k) + 1, n);
    },
    reorderPoints: function (k, j) {
      return (
        b(k instanceof Float32Array),
        b(k.length % j == 0),
        b(j >= 3),
        E(e.exports.meshopt_spatialSortRemap, k, k.length / j, j * 4)
      );
    },
    encodeVertexBuffer: function (k, j, d) {
      (b(d > 0 && d <= 256), b(d % 4 == 0));
      var n = e.exports.meshopt_encodeVertexBufferBound(j, d);
      return F(e.exports.meshopt_encodeVertexBuffer, n, k, j, d);
    },
    encodeVertexBufferLevel: function (k, j, d, n, t) {
      (b(d > 0 && d <= 256),
        b(d % 4 == 0),
        b(n >= 0 && n <= 3),
        b(t === void 0 || t == 0 || t == 1));
      var a = e.exports.meshopt_encodeVertexBufferBound(j, d);
      return F(
    ...
    encodeIndexBuffer: function (k, j, d) {
      (b(d == 2 || d == 4), b(j % 3 == 0));
      var n = A(k, d),
        t = e.exports.meshopt_encodeIndexBufferBound(j, y(n) + 1);
      return F(e.exports.meshopt_encodeIndexBuffer, t, n, j, 4);
    },
    encodeIndexSequence: function (k, j, d) {
      b(d == 2 || d == 4);
      var n = A(k, d),
        t = e.exports.meshopt_encodeIndexSequenceBound(j, y(n) + 1);
      return F(e.exports.meshopt_encodeIndexSequence, t, n, j, 4);
    },
    encodeGltfBuffer: function (k, j, d, n, t) {
      var a = {
        ATTRIBUTES: this.encodeVertexBufferLevel,
        TRIANGLES: this.encodeIndexBuffer,
        INDICES: this.encodeIndexSequence,
      };
      return (b(a[n]), a[n](k, j, d, 2, t === void 0 ? 0 : t));
    },
    encodeFilterOct: function (k, j, d, n) {
      return (
        b(d == 4 || d == 8),
        b(n >= 2 && n <= 16),
        O(e.exports.meshopt_encodeFilterOct, k, j, d, n, 16)
      );
    },
    encodeFilterQuat: function (k, j, d, n) {
      return (
        b(d == 8),
        b(n >= 4 && n <= 16),
        O(e.exports.meshopt_encodeFilterQuat, k, j, d, n, 16)
      );
    },
    encodeFilterExp: function (k, j, d, n, t) {
      (b(d > 0 && d % 4 == 0), b(n >= 1 && n <= 24));
      var a = { Separate: 0, SharedVector: 1, SharedComponent: 2, Clamped: 3 };
      return O(e.exports.meshopt_encodeFilterExp, k, j, d, n, d, t ? a[t] : 1);
    },
    encodeFilterColor: function (k, j, d, n) {
      return (
        b(d == 4 || d == 8),
        b(n >= 2 && n <= 16),
        O(e.exports.meshopt_encodeFilterColor, k, j, d, n, 16)
      );
    },
  };
})();
var Ua = (function () {
  ...
  if (typeof WebAssembly != "object") return { supported: !1 };
  var s = WebAssembly.validate(e) ? p(o) : p(c),
    b,
    r = WebAssembly.instantiate(s, {}).then(function (t) {
  ...
  function E(t, a, h, f, i, l, m) {
    var w = t.exports.sbrk,
      x = (f + 3) & -4,
      N = w(x * i),
      v = w(l.length),
      I = new Uint8Array(t.exports.memory.buffer);
    I.set(l, v);
    var U = a(N, f, i, v, l.length);
    if (
      (U == 0 && m && m(N, x, i),
  ...
  function d(t, a, h, f, i) {
    ...
    return new Promise(function (w, x) {
      var N = new Uint8Array(h),
        v = ++O;
      ((l.pending += t),
        (l.requests[v] = { resolve: w, reject: x }),
  ...
  return {
    ...
    decodeVertexBuffer: function (t, a, h, f, i) {
      E(b, b.exports.meshopt_decodeVertexBuffer, t, a, h, f, b.exports[F[i]]);
    },
    decodeIndexBuffer: function (t, a, h, f) {
      E(b, b.exports.meshopt_decodeIndexBuffer, t, a, h, f);
    },
    decodeIndexSequence: function (t, a, h, f) {
      E(b, b.exports.meshopt_decodeIndexSequence, t, a, h, f);
    },
    decodeGltfBuffer: function (t, a, h, f, i, l) {
      E(b, b.exports[y[i]], t, a, h, f, b.exports[F[l]]);
    },
    decodeGltfBufferAsync: function (t, a, h, f, i) {
      return A.length > 0
        ...
        : r.then(function () {
            ...
            return (E(b, b.exports[y[f]], l, t, a, h, b.exports[F[i]]), l);
          });
    },
  };
})();
var Te = (function () {
  ...
  if (typeof WebAssembly != "object") return { supported: !1 };
  var e,
    g = WebAssembly.instantiate(s(c), {}).then(function (a) {
  ...
  function E(a, h, f) {
    var i = e.exports.sbrk,
      l = i(h.length * 4),
      m = i(f * 4),
      w = new Uint8Array(e.exports.memory.buffer),
      x = r(h);
    w.set(x, l);
    var N = a(m, l, h.length, f);
    w = new Uint8Array(e.exports.memory.buffer);
    var v = new Uint32Array(f);
    (new Uint8Array(v.buffer).set(w.subarray(m, m + f * 4)),
      x.set(w.subarray(l, l + h.length * 4)),
      i(l - i(0)));
  ...
  function y(a, h, f, i, l, m, w, x, N) {
    ...
    (D.set(r(i), B), D.set(r(h), M));
    var z = a(U, M, f, B, l, m, w, x, N, I);
    D = new Uint8Array(e.exports.memory.buffer);
    var C = new Uint32Array(z);
    r(C).set(D.subarray(U, U + z * 4));
    var H = new Float32Array(1);
    return (r(H).set(D.subarray(I, I + 4)), v(I - v(0)), [C, H[0]]);
  }
  function A(a, h, f, i, l, m, w, x, N, v, I, U, B) {
    var M = e.exports.sbrk,
      D = M(4),
      z = M(f * 4),
      C = M(l * m),
      H = M(l * x),
    ...
    (L.set(r(i), C),
      ...
      L.set(r(h), W),
      v && L.set(r(v), X));
    var aa = a(z, W, f, C, l, m, H, x, T, N.length, X, I, U, B, D);
    L = new Uint8Array(e.exports.memory.buffer);
    var G = new Uint32Array(aa);
    r(G).set(L.subarray(z, z + aa * 4));
    var R = new Float32Array(1);
    return (r(R).set(L.subarray(D, D + 4)), M(D - M(0)), [G, R[0]]);
  }
  function O(a, h, f, i, l, m, w, x, N, v, I, U, B) {
    var M = e.exports.sbrk,
      D = M(4),
      z = M(l * m),
      C = M(l * x),
    ...
    (X.set(r(i), z),
      ...
      X.set(r(h), T),
      v && X.set(r(v), W));
    var L = a(T, f, z, l, m, C, x, H, N.length, W, I, U, B, D);
    ((X = new Uint8Array(e.exports.memory.buffer)),
      r(h).set(X.subarray(T, T + L * 4)),
      r(i).set(X.subarray(z, z + l * m)),
      r(w).set(X.subarray(C, C + l * x)));
    var aa = new Float32Array(1);
    return (r(aa).set(X.subarray(D, D + 4)), M(D - M(0)), [L, aa[0]]);
  }
  function k(a, h, f, i) {
    var l = e.exports.sbrk,
      m = l(f * i),
  ...
  function j(a, h, f, i, l, m, w, x) {
    var N = e.exports.sbrk,
      v = N(x * 4),
      I = N(f * i),
      U = N(f * m),
      B = new Uint8Array(e.exports.memory.buffer);
    (B.set(r(h), I), l && B.set(r(l), U));
    var M = a(v, I, f, i, U, m, w, x);
    B = new Uint8Array(e.exports.memory.buffer);
    var D = new Uint32Array(M);
    return (r(D).set(B.subarray(v, v + M * 4)), N(v - N(0)), D);
  }
  function d(a, h, f, i, l, m, w, x, N) {
    var v = e.exports.sbrk,
      I = v(4),
      U = v(f * 4),
      B = v(l * m),
    ...
    (z.set(r(i), B), z.set(r(h), M), w && z.set(r(w), D));
    var C = a(U, M, f, B, l, m, D, x, N, I);
    z = new Uint8Array(e.exports.memory.buffer);
    var H = new Uint32Array(C);
    r(H).set(z.subarray(U, U + C * 4));
    var T = new Float32Array(1);
    return (r(T).set(z.subarray(I, I + 4)), v(I - v(0)), [H, T[0]]);
  }
  function n(a, h, f, i, l, m, w) {
    var x = e.exports.sbrk,
      N = x(f * 4),
      v = x(l * m),
      I = x(f * 4),
      U = new Uint8Array(e.exports.memory.buffer);
    (U.set(r(i), v), U.set(r(h), I));
    var B = a(N, I, f, v, l, m, w);
    U = new Uint8Array(e.exports.memory.buffer);
    var M = new Uint32Array(B);
    return (r(M).set(U.subarray(N, N + B * 4)), x(N - x(0)), M);
  }
  var t = {
    LockBorder: 1,
    Sparse: 2,
  ...
  return {
    ...
    compactMesh: function (a) {
      ...
      return E(e.exports.meshopt_optimizeVertexFetchRemap, h, F(a) + 1);
    },
    generatePositionRemap: function (a, h) {
      return (
        ...
        b(a.length % h == 0),
        b(h >= 3),
        p(e.exports.meshopt_generatePositionRemap, a, a.length / h, h)
      );
    },
    simplify: function (a, h, f, i, l, m) {
      (b(
        ...
        b(i % 3 == 0),
        b(l >= 0));
      for (var w = 0, x = 0; x < (m ? m.length : 0); ++x)
        (b(m[x] in t), (w |= t[m[x]]));
    ...
    simplifyWithAttributes: function (a, h, f, i, l, m, w, x, N, v) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
        ...
        b(l >= 0),
        b(w == null || w instanceof Uint8Array),
        b(w == null || w.length == h.length / f),
        b(x >= 0 && x <= a.length),
        b(x % 3 == 0),
        b(N >= 0),
        b(Array.isArray(m)),
      ...
      for (var U = 0, I = 0; I < (v ? v.length : 0); ++I)
        (b(v[I] in t), (U |= t[v[I]]));
      ...
      return (
        (M[0] = a instanceof Uint32Array ? M[0] : new a.constructor(M[0])),
        M
      );
    },
    simplifyWithUpdate: function (a, h, f, i, l, m, w, x, N, v) {
      (b(
        a instanceof Uint32Array ||
          a instanceof Int32Array ||
          a instanceof Uint16Array ||
      ...
      if (a !== B) for (var I = 0; I < M[0]; ++I) a[I] = B[I];
      return M;
    },
    ...
    simplifySloppy: function (a, h, f, i, l, m) {
      (b(
        ...
        b(l % 3 == 0),
        b(m >= 0));
      var w = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
        x = d(
...
var Pe = (function () {
  ...
  if (typeof WebAssembly != "object") return { supported: !1 };
  var e,
    g = WebAssembly.instantiate(s(c), {}).then(function (d) {
  ...
  function y(d, n, t, a, h, f, i, l, m, w) {
    var x = e.exports.sbrk,
      ...
      M = x(t.byteLength),
      D = new Uint8Array(e.exports.memory.buffer);
    (D.set(r(n), B), D.set(r(t), M));
    var z = d(v, I, U, B, n.length, M, a, h, f, i, l, m, w);
    D = new Uint8Array(e.exports.memory.buffer);
    for (
      var C = D.subarray(v, v + z * E),
      ...
      var W = H[T * 4 + 0],
        ...
        a = H[T * 4 + 2],
        L = H[T * 4 + 3];
      e.exports.meshopt_optimizeMeshlet(I + W * 4, U + X, L, a);
    }
    var aa = H[(z - 1) * 4 + 0],
      G = H[(z - 1) * 4 + 1],
      R = H[(z - 1) * 4 + 2],
      ...
      ca = {
        ...
        triangles: new Uint8Array(D.buffer, U, S * 3).slice(),
        meshletCount: z,
      };
    return (x(v - x(0)), ca);
  }
  function A(d) {
    var n = new Float32Array(e.exports.memory.buffer, d, p / 4);
    return {
      centerX: n[0],
      centerY: n[1],
      centerZ: n[2],
  ...
  function O(d, n, t, a) {
    ...
    for (var N = 0; N < d.meshletCount; ++N) {
      var v = d.meshlets[N * 4 + 0],
        ...
        U = d.meshlets[N * 4 + 0 + 3];
      (e.exports.meshopt_computeMeshletBounds(w, l + v * 4, m + I, U, i, t, a),
        f.push(A(w)));
    }
    return (h(i - h(0)), f);
  }
...
var Bb = ac;
function zb() {
  if (!Q(_._canTransferArrayBuffer)) {
    ...
    _._canTransferArrayBuffer = new Promise((g) => {
      c.onmessage = function (s) {
        let b = s.data.array,
          r = Q(b) && b[0] === o;
        (g(r), c.terminate(), (_._canTransferArrayBuffer = r));
      };
    });
  }
...
function mb(c) {
  ...
  if (hb(c)) r = c;
    ...
    let p = Na(`${_._workerModulePrefix}/${g}.js`);
    hb(p) && (r = p);
  }
  if (r) {
    let p = `import "${r}";`;
    return ((b = ob(p)), (s.type = "module"), new Worker(b, s));
  }
  if (!e && typeof CESIUM_WORKERS < "u") {
    let p = `
      ...
      CesiumWorkers["${g}"]();
    `;
    return ((b = ob(p)), new Worker(b, s));
  }
  if (
    ((b = c),
    e || (b = Na(`${_._workerModulePrefix + g}.js`)),
    !nb.supportsEsmWebWorkers())
  )
    throw new za(
      "This browser is not supported. Please update your browser to continue.",
    );
  return ((s.type = "module"), new Worker(b, s));
}
async function bc(c, o) {
  ...
  let g = await Mb.fetchArrayBuffer({ url: e.wasmBinaryFile });
...
async function dc(c, o, e) {
  ...
  Q(e) ? g || (e.length = 0) : (e = ec);
  let s = c._nextID++,
    b = new Promise((r, p) => {
      c._worker.addEventListener("message", cc(c._worker, s, r, p));
    });
  return (
...
_.prototype.scheduleTask = function (c, o) {
  if (
    (Q(this._worker) || (this._worker = mb(this._workerPath)),
    !(this._activeTasks >= this._maximumActiveTasks))
  )
    return fc(this, c, o);
};
_.prototype.initWebAssemblyModule = async function (c) {
  if (Q(this._webAssemblyPromise)) return this._webAssemblyPromise;
  let o = async () => {
    let e = (this._worker = mb(this._workerPath)),
      g = await bc(this, c),
      s = await Promise.resolve(zb()),
      b,
      r = g.wasmBinary;
    Q(r) && s && (b = [r]);
    let p = new Promise((E, F) => {
      e.onmessage = function ({ data: y }) {
        Q(y) ? E(y.result) : F(new za("Could not configure wasm module"));
      };
    });
    return (
      e.postMessage(
        { canTransferArrayBuffer: s, parameters: { webAssemblyConfig: g } },
        b,
      ),
      p
    );
...
_.prototype.destroy = function () {
  return (Q(this._worker) && this._worker.terminate(), Bb(this));
};
_.taskCompletedEvent = lb;
_._defaultWorkerModulePrefix = "Workers/";
_._workerModulePrefix = _._defaultWorkerModulePrefix;
_._canTransferArrayBuffer = void 0;
var Kb = _;
var hc = 3;
function kb(c, o, e) {
...
kb.prototype.rayIntersect = function (c, o, e, g, s) {
...
function Tb(c, o, e) {
  let g = 1 / Math.pow(2, e),
    s = u.fromElements(c * g - 0.5, o * g - 0.5, -0.5, ic),
    b = u.fromElements((c + 1) * g - 0.5, (o + 1) * g - 0.5, 0.5, gc);
  return Ha.fromCorners(s, b);
}
function oc(c, o, e, g, s) {
  (u.pack(e[0], c, 9 * s),
    u.pack(e[1], c, 9 * s + 3),
    u.pack(e[2], c, 9 * s + 6),
    (o[s] = g));
...
function mc(c, o, e, g, s, b) {
  let r = o.sort(function (E, F) {
      return E.interval.start - F.interval.start;
    }),
    p = Number.MAX_VALUE;
  for (let E = 0; E < r.length; E++) {
    let F = r[E],
      y = sc(c, e, F.node, g, s, b);
    if (((p = Math.min(y, p)), p !== Number.MAX_VALUE)) break;
  }
  if (p !== Number.MAX_VALUE) return ib.getPoint(e, p);
}
function sc(c, o, e, g, s, b) {
  let r = Number.MAX_VALUE,
    p = c._encoding,
    E = c._indices,
    F = c._vertices,
    y = e.intersectingTriangles.length,
    O = !(e.level >= hc) && !e.buildingChildren,
    k,
    j;
  O && ((k = new Float64Array(y * 9)), (j = new Uint32Array(y)));
  for (let d = 0; d < y; d++) {
    let n = e.intersectingTriangles[d],
      t = sb(p, s, b, o, F, E[3 * n], Za[0]),
      a = sb(p, s, b, o, F, E[3 * n + 1], Za[1]),
      h = sb(p, s, b, o, F, E[3 * n + 2], Za[2]),
      f = gb.rayTriangleParametric(o, t, a, h, g);
    (Q(f) && f < r && f >= 0 && (r = f), O && oc(k, j, Za, n, d));
  }
  if (O) {
    for (let d = 0; d < 4; d++) e.addChild(d);
    kc(c._inverseTransform, e, j, k);
  }
  return r;
}
var jc = new V();
function sb(c, o, e, g, s, b, r) {
  let p = c.getExaggeratedPosition(s, b, r);
  if (o === Ya.SCENE3D) return p;
  let F = e.ellipsoid.cartesianToCartographic(p, jc);
  ((p = e.project(F, r)), (p = u.fromElements(p.z, p.x, p.y, r)));
  let y = $.TWO_PI * e.ellipsoid.maximumRadius,
    A = Math.round((g.origin.y - p.y) / y);
  return ((p.y += A * y), p);
}
async function kc(c, o, e, g) {
  ...
  for (let y = 0; y < 4; y++)
    (u.pack(o.children[y].aabb.minimum, b, y * 6),
      u.pack(o.children[y].aabb.maximum, b, y * 6 + 3));
  let r = {
      aabbs: b,
      inverseTransform: s,
      triangleIndices: e,
    ...
    p = [b.buffer, s.buffer, e.buffer, g.buffer],
    E = nc.scheduleTask(r, p);
  if (!Q(E)) {
    o.buildingChildren = !1;
    return;
  }
  ((await E).intersectingTrianglesArrays.forEach((y, A) => {
    Q(o.children[A]) &&
      (o.children[A].intersectingTriangles = new Uint32Array(y));
  }),
    (o.intersectingTriangles = new Uint32Array(0)),
    (o.buildingChildren = !1));
}
var Pb = kb;
function qa(c, o, e, g, s, b, r, p, E, F, y, A, O, k, j, d, n) {
  ((this.center = c),
    (this.vertices = o),
    (this.stride = y ?? 6),
    (this.indices = e),
    (this.indexCountWithoutSkirts = g),
    (this.vertexCountWithoutSkirts = s),
    (this.minimumHeight = b),
    (this.maximumHeight = r),
    (this.rectangle = p),
    (this.boundingSphere3D = E),
    (this.occludeePointInScaledSpace = F),
    (this.orientedBoundingBox = A),
    (this.encoding = O),
    (this.westIndicesSouthToNorth = k),
    (this.southIndicesEastToWest = j),
...
qa.prototype.getTransform = function (c, o) {
  return this._lastPickSceneMode === c
    ? this._transform
...
function uc(c, o) {
  let e = c.encoding.exaggeration,
    ...
    s = Pa.getHeight(c.minimumHeight, e, g),
    b = Pa.getHeight(c.maximumHeight, e, g),
    r = ra.fromRectangle(c.rectangle, s, b, Aa.default, c.orientedBoundingBox);
...
function Ic(c, o, e) {
  let g = c.encoding.exaggeration,
    s = c.encoding.exaggerationRelativeHeight,
    b = Pa.getHeight(c.minimumHeight, g, s),
    r = Pa.getHeight(c.maximumHeight, g, s),
    p = o.project(
    ...
    F = r - b,
    y = u.fromElements(E.x - p.x, E.y - p.y, F > 0 ? F : 1, Ec),
    A = u.fromElements(p.x + y.x * 0.5, p.y + y.y * 0.5, b + y.z * 0.5, vc);
  return (
...
qa.prototype.pick = function (c, o, e, g) {
  let s = this._terrainPicker.rayIntersect(c, this.getTransform(e, g), o, e, g);
  return ((this._lastPickSceneMode = e), s);
};
...
pb.createMesh = async function (c) {
  ...
  (J.typeOf.object("options.ellipsoid", c.ellipsoid),
    ...
    J.typeOf.bool("options.hasWebMercatorT", s),
    J.typeOf.object("options.gltf", b),
    J.typeOf.number("options.minimumHeight", r),
    J.typeOf.number("options.maximumHeight", p),
  ...
  let a = d.west,
    ...
    m = xa.center(d, Nc);
  m.height = 0.5 * (r + p);
  let w = V.toCartesian(m, j, Fc),
    x = Ta.eastNorthUpToFixedFrame(w, j, Mc),
    N = P.inverseTransformation(x, Uc),
    v = P.unpack(b.nodes[0].matrix, 0, Oc);
  v = P.multiply(Ob.Y_UP_TO_Z_UP, v, v);
  let I = pe(b, g, Ac),
    U = Ma.getSkirtVertexCount(
      I.edgeIndicesWest,
      I.edgeIndicesSouth,
      I.edgeIndicesEast,
      I.edgeIndicesNorth,
    ...
    C = z + U,
    H = D.length,
    T = Ma.getSkirtIndexCountWithFilledCorners(U),
    W = C <= 65535 ? Uint16Array : Uint32Array,
    X = new W(H + T);
  X.set(D);
  let L = new W(I.edgeIndicesWest),
    aa = new W(I.edgeIndicesSouth),
    ...
    S = new W(G).sort(),
    ca = new W(R).sort(),
    ba = Ea.geodeticLatitudeToMercatorAngle(h),
    ia = 1 / (Ea.geodeticLatitudeToMercatorAngle(f) - ba),
    ga = u.fromElements(
    ...
    la = new Fa(A.center, void 0, void 0, void 0, void 0, g, s, y, o, e),
    oa = la.stride,
  ...
  for (let Y = 0; Y < z; Y++) {
    ...
    let Wa = K.fromElements(ja, ua, Hc),
      Ba;
    if (g) {
      let na = u.unpack(M, Y * 3, Ja);
      ((na = P.multiplyByPointAsVector(v, na, Ja)),
        (na = u.normalize(na, Ja)),
        (Ba = rb.octEncode(na, Pc)));
    }
    let pa;
    s && (pa = (Ea.geodeticLatitudeToMercatorAngle(Oa) - ba) * ia);
    let Ra;
    (y && (Ra = j.geodeticSurfaceNormal(ma, qc)),
  ...
  return (Sb(fa, d, j, ga, ha, x, N, E), Promise.resolve(fa));
};
var Cc = new K(),
  Wc = new K(),
  Rc = new Array(6),
...
function je(c) {
  ...
  let r = c.buffers[b.buffer].extras._pipeline.source,
    ...
    E = b.byteStride,
    F = E === 4 ? Uint8Array : Uint16Array,
    y = new F(s * 4);
  Ua.decodeVertexBuffer(new Uint8Array(y.buffer), s, E, p);
  let A = (1 << (y.BYTES_PER_ELEMENT * 8)) - 1,
...
function ke(c) {
  ...
  let r = c.buffers[b.buffer].extras._pipeline.source,
    ...
    E = b.byteStride,
    F = new Int8Array(s * E);
  Ua.decodeVertexBuffer(new Uint8Array(F.buffer), s, E, p);
  let y = new Float32Array(s * 3);
  for (let A = 0; A < s; A++) {
    let O = Math.max(F[A * 4 + 0] / 127, -1),
      k = Math.max(F[A * 4 + 1] / 127, -1),
      j = 1 - (Math.abs(O) + Math.abs(k));
    if (j < 0) {
      let n = O,
        t = k;
      ((O = (1 - Math.abs(t)) * $.signNotZero(n)),
        (k = (1 - Math.abs(n)) * $.signNotZero(t)));
    }
    let d = Ja;
    ((d.x = O),
      (d.y = k),
...
function ue(c) {
  ...
  if (r === void 0) {
    let y = c.buffers[g.buffer].extras._pipeline.source;
    return new b(
      y.buffer,
      y.byteOffset + (g.byteOffset ?? 0) + (e.byteOffset ?? 0),
      s,
    );
  }
  let p = c.buffers[r.buffer].extras._pipeline.source,
    E = new Uint8Array(
      p.buffer,
      p.byteOffset + (r.byteOffset ?? 0) + (e.byteOffset ?? 0),
      r.byteLength,
    ),
    F = new b(s);
  return (
    Ua.decodeIndexBuffer(new Uint8Array(F.buffer), s, r.byteStride, E),
    F
  );
}
function $a(c, o) {
  let e = c.meshes[0].primitives[0],
    ...
    s = c.bufferViews[g.bufferView],
    b = g.count,
    r = g.componentType === tb.UNSIGNED_SHORT ? Uint16Array : Uint32Array,
    p = s.extensions ? s.extensions.EXT_meshopt_compression : void 0;
  if (p === void 0) {
    let O = c.buffers[s.buffer].extras._pipeline.source;
    return new r(
      O.buffer,
      O.byteOffset + (s.byteOffset ?? 0) + (g.byteOffset ?? 0),
      b,
    );
  }
  let E = c.buffers[p.buffer].extras._pipeline.source,
    F = new Uint8Array(
      E.buffer,
      E.byteOffset + (p.byteOffset ?? 0) + (g.byteOffset ?? 0),
      p.byteLength,
    ),
    y = new r(b),
    A = p.byteStride;
  return (Ua.decodeIndexSequence(new Uint8Array(y.buffer), b, A, F), y);
}
function pe(c, o, e) {
  return (
    (e.positions = je(c)),
...
pb.upsampleMesh = function (c) {
  ...
  (J.typeOf.bool("options.isEastChild", o),
    ...
    J.typeOf.number("options.parentMaximumHeight", s),
  ...
  let r = c.parentIndexCountWithoutSkirts,
    p = c.parentIndices,
    E = c.parentVertexCountWithoutSkirts,
    F = c.parentVertices,
    y = Fa.clone(c.parentEncoding, new Fa()),
    A = y.hasVertexNormals,
    O = y.hasWebMercatorT,
    k = y.exaggeration,
    j = y.exaggerationRelativeHeight,
    n = k !== 1,
    ...
    x = [],
    N = [];
  Be(o, e, r, p, E, F, y, l, m, w, x, N, h, i, f);
  let v = xa.center(t, Zc);
  v.height = 0.5 * (g + s);
  let I = V.toCartesian(v, a, Qc),
    U = h.length,
    B = new Fa(I, void 0, void 0, void 0, void 0, A, O, n, k, j),
    M = B.stride,
    D = Ma.getSkirtVertexCount(m, w, x, N),
    z = U + D,
    C = l.length,
    H = Ma.getSkirtIndexCountWithFilledCorners(D),
    T = C + H,
  ...
  for (let sa = 0; sa < U; sa++) {
    ...
    let Ra = pa.x,
      ...
      Da = i[sa * 2 + 1],
      Sa = 1 - na - Da,
      Lb = y.decodeHeight(F, ua),
      Gb = y.decodeHeight(F, Wa),
      Vb = y.decodeHeight(F, Ba),
      La = Lb * na + Gb * Da + Vb * Sa;
    ((ea = Math.min(La, ea)), (da = Math.max(La, da)));
    let Yb = $.lerp(ba, ta, Ra),
      Eb = $.lerp(ia, ga, Xa),
    ...
    let Ib;
    if (A) {
      let Ga = y.decodeNormal(F, ua, Gc),
        bb = y.decodeNormal(F, Wa, Vc),
        cb = y.decodeNormal(F, Ba, Yc),
        eb = u.fromElements(
  ...
  let va = ra.fromRectangle(t, ea, da, a, oe),
    ma = wa.fromVertices(q, B.center, M, ge),
    _a = new Ub(a).computeHorizonCullingPointFromVerticesPossiblyUnderEllipsoid(
      B.center,
      q,
      M,
      B.center,
...
function Sb(c, o, e, g, s, b, r, p) {
  let { encoding: E } = c,
    ...
    w = c.southIndicesEastToWest,
    x = c.eastIndicesNorthToSouth,
    N = c.northIndicesWestToEast;
  Ma.addSkirtIndicesWithFilledCorners(m, w, x, N, t, i, l);
  let v = 0,
    I = v + m.length,
    U = I + w.length,
    B = U + x.length,
  ...
  for (let G = 0; G < f; G++) {
    ...
    let q = M[R][G - D[R]],
      Z = E.decodeTextureCoordinates(y, q, Jb),
      S = 1e-4,
      ca = Z.x + z[R] * S,
      ba = Z.y + C[R] * S,
      ta = $.lerp(o.west, o.east, ca),
      ia = $.clamp(
        $.lerp(o.south, o.north, ba),
        -$.PI_OVER_TWO,
        +$.PI_OVER_TWO,
      ),
      ha = E.decodeHeight(y, q) - p,
      la = V.fromRadians(ta, ia, ha, $c),
      oa = V.toCartesian(la, e, qb),
      ea;
    A && (ea = E.getOctEncodedNormal(y, q, Wb));
    let da;
    O && (da = E.decodeWebMercatorT(y, q));
    let fa;
    (n && (fa = e.geodeticSurfaceNormal(oa, Rb)),
      (a = E.encode(y, a, oa, Z, ha, ea, da, fa)));
  ...
  if (E.quantization !== aa.quantization) {
    let G = aa,
      R = G.stride,
    ...
    for (let S = 0; S < h; S++)
      Z = G.encode(
        q,
        Z,
        E.decodePosition(y, S, qb),
        E.decodeTextureCoordinates(y, S, Jb),
        E.decodeHeight(y, S),
        E.hasVertexNormals ? E.getOctEncodedNormal(y, S, Wb) : void 0,
        E.hasWebMercatorT ? E.decodeWebMercatorT(y, S) : void 0,
        E.hasGeodeticSurfaceNormals
          ? E.decodeGeodeticSurfaceNormal(y, S, Rb)
          : void 0,
      );
...
function Ne(c, o, e, g, s, b) {
  let r, p, E;
  switch (e) {
    case wb:
      ((r = (c.x - g.x) / (s.x - g.x)), (p = c.x), (E = g.y + (s.y - g.y) * r));
      break;
    case yb:
      ((r = (o.x - g.x) / (s.x - g.x)), (p = o.x), (E = g.y + (s.y - g.y) * r));
      break;
    case xb:
      ((r = (c.y - g.y) / (s.y - g.y)), (p = g.x + (s.x - g.x) * r), (E = c.y));
      break;
    default:
      ((r = (o.y - g.y) / (s.y - g.y)), (p = g.x + (s.x - g.x) * r), (E = o.y));
      break;
  }
  return u.fromElements(p, E, r, b);
}
var Fe = {
  length: 0,
...
function Me(c, o, e, g, s, b, r, p) {
  let E = 0,
    F = ve,
    y = Ee,
    A = 3,
    O = Ae;
  (K.clone(s, O[0]), K.clone(b, O[1]), K.clone(r, O[2]));
  let k = Ie;
    ...
    for (let l = 0; l < E; l++) {
      ...
      if (i * x === -1) {
        let N = Ne(e, g, d, h, m, xe),
          ...
          D = f.y * B + w.y * U,
          z = f.z * B + w.z * U;
        (K.fromElements(v, I, O[A]), u.fromElements(M, D, z, k[A]), A++);
      }
      (x >= 0 && (K.clone(m, O[A]), u.clone(w, k[A]), A++),
        (a = l),
        (h = m),
        (f = w),
        (i = x));
  ...
  p.length = A;
  for (let j = 0; j < A; j++)
    (K.clone(O[j], p.coordinates[j]),
      u.clone(k[j], p.barycentricCoordinates[j]));
  return p;
}
function Ue(c, o, e, g, s, b, r, p) {
  return Me(c ? (o ? xb : wb) : o ? yb : we, 2, e, g, s, b, r, p);
}
var Oe = [[], [0], [1], [0, 1], [2], [0, 2], [1, 2], [0, 1, 2]];
function Be(c, o, e, g, s, b, r, p, E, F, y, A, O, k, j) {
  let d = {},
    n = c ? 0.5 : 0,
    t = c ? 1 : 0.5,
    a = o ? 0.5 : 0,
  ...
  for (let m = 0; m < e; m += 3) {
    let w = g[m + 0],
      x = g[m + 1],
      N = g[m + 2],
      v = r.decodeTextureCoordinates(b, w, Xc),
      I = r.decodeTextureCoordinates(b, x, Sc),
      U = r.decodeTextureCoordinates(b, N, Lc),
      B = Ue(c, o, f, i, v, I, U, Fe),
      M = B.length;
    if (M < 3) continue;
    let D = Rc;
    for (let T = 0; T < M; T++) {
      let W = B.barycentricCoordinates[T],
        ...
        L = W.y,
        aa = W.z,
        G = Math.ceil(X) | (Math.ceil(L) << 1) | (Math.ceil(aa) << 2),
        R = Oe[G],
        q,
        Z = !1;
      if (R.length === 1) {
        let S = R[0],
          ba = g[m + S];
        ((q = d[ba]), q === void 0 && ((Z = !0), (q = l++), (d[ba] = q)));
      } else if (R.length === 2) {
        let S = R[0],
          ca = R[1],
          ba = g[m + S],
          ta = g[m + ca],
          ia = B.barycentricCoordinates[(T + M - 1) % M],
          ga =
    ...
    let z = D[0],
      ...
      H = D[2];
    p.push(z, C, H);
    for (let T = 3; T < M; T++) ((C = H), (H = D[T]), p.push(z, C, H));
  }
  (E.sort(function (m, w) {
    return j[m * 2 + 1] - j[w * 2 + 1];
  }),
    F.sort(function (m, w) {
      return j[w * 2 + 0] - j[m * 2 + 0];
    }),
    y.sort(function (m, w) {
      return j[w * 2 + 1] - j[m * 2 + 1];
    }),
    A.sort(function (m, w) {
      return j[m * 2 + 0] - j[w * 2 + 0];
    }));
}
var cf = pb;
export { cf as a };
